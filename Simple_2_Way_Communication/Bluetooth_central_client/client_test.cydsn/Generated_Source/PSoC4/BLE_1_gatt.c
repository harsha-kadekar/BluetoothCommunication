    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'C', (uint8)'l', (uint8)'i', (uint8)'e', (uint8)'n', (uint8)'t', (uint8)' ', (uint8)'B', (uint8)'L', (uint8)'E', 
    ...
    (uint8)'O', (uint8)'n', (uint8)'O', (uint8)'f', (uint8)'f', (uint8)'D', (uint8)'a', (uint8)'t', (uint8)'a', 
...
const uint8 cyBle_attUuid128[][16u] = {
    /* ONOffService */
    { 0x20u, 0x13u, 0xB0u, 0xF9u, 0x05u, 0x08u, 0x00u, 0x00u, 0x08u, 0x00u, 0x01u, 0x00u, 0xBAu, 0xCBu, 0x03u, 0x00u },
    /* Custom Characteristic */
    { 0x20u, 0x13u, 0xB0u, 0xF9u, 0x05u, 0x08u, 0x00u, 0x00u, 0x08u, 0x00u, 0x01u, 0x00u, 0xBCu, 0xCBu, 0x03u, 0x00u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* ONOffService UUID */
    ...
    { 0x0002u, (void *)&cyBle_attValues[17] }, /* Server Characteristic Configuration */
    { 0x0009u, (void *)&cyBle_attValues[19] }, /* Characteristic User Description */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x0Fu] = {
    ...
    { 0x000Au, 0x2800u /* Primary service                     */, 0x00080001u /*           */, 0x000Fu, {{0x0010u, (void *)&cyBle_attValuesLen[4]}} },
    { 0x000Bu, 0x2803u /* Characteristic                      */, 0x00001301u /* br,rd,ntf */, 0x000Fu, {{0x0010u, (void *)&cyBle_attValuesLen[5]}} },
    { 0x000Cu, 0xCBBCu /* Custom Characteristic               */, 0x00091301u /* br,rd,ntf */, 0x000Fu, {{0x0001u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x000Du, 0x2902u /* Client Characteristic Configuration */, 0x00010A04u /* rd,wr     */, 0x000Du, {{0x0002u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x000Eu, 0x2903u /* Server Characteristic Configuration */, 0x00010A04u /* rd,wr     */, 0x000Eu, {{0x0002u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x000Fu, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd        */, 0x000Fu, {{0x0009u, (void *)&cyBle_attValuesLen[9]}} },
};
