...
#define CYBLE_ONOFFSERVICE_SERVICE_INDEX   (0x00u) /* Index of ONOffService service in the cyBle_customs array */
#define CYBLE_ONOFFSERVICE_CUSTOM_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of Custom Characteristic characteristic */
#define CYBLE_ONOFFSERVICE_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_ONOFFSERVICE_CUSTOM_CHARACTERISTIC_SERVER_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Server Characteristic Configuration descriptor */
#define CYBLE_ONOFFSERVICE_CUSTOM_CHARACTERISTIC_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x02u) /* Index of Characteristic User Description descriptor */
...
#define CYBLE_ONOFFSERVICE_SERVICE_HANDLE   (0x000Au) /* Handle of ONOffService service */
#define CYBLE_ONOFFSERVICE_CUSTOM_CHARACTERISTIC_CHAR_HANDLE   (0x000Cu) /* Handle of Custom Characteristic characteristic */
#define CYBLE_ONOFFSERVICE_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Du) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_ONOFFSERVICE_CUSTOM_CHARACTERISTIC_SERVER_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Eu) /* Handle of Server Characteristic Configuration descriptor */
#define CYBLE_ONOFFSERVICE_CUSTOM_CHARACTERISTIC_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x000Fu) /* Handle of Characteristic User Description descriptor */
