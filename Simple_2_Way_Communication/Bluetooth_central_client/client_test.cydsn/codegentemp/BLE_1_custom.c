...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* ONOffService service */
    {
        0x000Au, /* Handle of the ONOffService service */ 
        {

            /* Custom Characteristic characteristic */
            {
                0x000Cu, /* Handle of the Custom Characteristic characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x000Du, /* Handle of the Client Characteristic Configuration descriptor */ 
                    0x000Eu, /* Handle of the Server Characteristic Configuration descriptor */ 
