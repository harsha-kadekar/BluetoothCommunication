...
module top ;
    ...
    SCB_P4_v3_0_1 SERIAL (
        .interrupt(Net_43),
        .clock(1'b0),
        .rx_tr_out(Net_45),
        .tx_tr_out(Net_46));

	wire [0:0] tmpOE__Pin_Status_net;
	wire [0:0] tmpFB_0__Pin_Status_net;
	wire [0:0] tmpIO_0__Pin_Status_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Status_net;
	electrical [0:0] tmpSIOVREF__Pin_Status_net;

	cy_psoc3_pins_v1_10
		#(.id("6c6f4968-4f68-4ecf-af71-7219a577ba46"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Status
		 (.oe(tmpOE__Pin_Status_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Status_net[0:0]}),
		  .io({tmpIO_0__Pin_Status_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Status_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Status_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Status_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
